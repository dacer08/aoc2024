...
//    private List<HashSet<string>> Results = [];
...
//        //Console.WriteLine(Results.Where(r => r.Pc1.StartsWith('t') || r.Pc2.StartsWith('t') || r.Pc3.StartsWith('t')).Count());
//        var a = Results.OrderByDescending(r => r.Count).ToList();
